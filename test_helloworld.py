...
def test_parser():
    """this fonction test the 'parser' fonction"""
    pars = localisation()
...
def test_wiki_api(monkeypatch):
    """this fonction test the Wikipedia API fonction"""
    ...
    assert result[0]["abstract"] == "La tour Eiffel  est une tour de fer\
...
def test_map_api(monkeypatch):
    """this fonction test the HERE API function"""
